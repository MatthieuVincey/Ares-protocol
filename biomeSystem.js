...
const BIOMES = {
    red_desert: {
        ...
        color: 0x2a2a2a,
        resources: ['Fer', 'Silicium', 'Aluminium', 'Cuivre', 'Titane', 'Nickel', 'Minerais_Rares', 'Verre', 'Or', 'Cristal'],
    ...
    cracked_ice: {
        ...
        color: 0xcceedd,
        resources: ['Glace', 'Hydrogene', 'Azote', 'Silicium', 'Eau', 'Methane', 'Gaz', 'Gaz_Rares', 'Cobalt'],
    ...
    crystal_valley: {
        ...
        color: 0xaa44ff,
        resources: ['Cristal_Energie', 'Cristal_Quantique', 'Cristal_Atmo', 'Platine', 'Cristal', 'Artefact', 'Cristal_Bio', 'Tungstene'],
    ...
    volcanic_plain: {
        ...
        color: 0x221100,
        resources: ['Iridium', 'Tungstene', 'Methane', 'Cobalt', 'Minerais_Rares', 'Or', 'Fer', 'Cuivre', 'Titane'],
    ...
    future_oasis: {
        ...
        color: 0x2a5a30,
        resources: ['Eau', 'Algue_Alien', 'Biomasse', 'Plante_Alien', 'Biomasse_Primitive', 'Cristal_Bio', 'Gaz'],
    ...
    meteor_crater: {
        ...
        color: 0x443333,
        resources: ['Iridium', 'Platine', 'Or', 'Artefact', 'Minerais_Rares', 'Cristal_Energie', 'Cristal_Quantique', 'Tungstene'],
    ...
    alien_ruins: {
        ...
        color: 0x444444,
        resources: ['Cristal_Quantique', 'Artefact', 'Scrap', 'Minerais_Rares', 'Aluminium', 'Cristal_Energie', 'Fer', 'Cuivre'],
